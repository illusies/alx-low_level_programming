...
/**
 * shash_table_create - Function that creates a shash table with a given size
...
/**
 * add_n_shash - Function that adds a node at the beginning
...
/**
 * add_i_shash - Function that adds a node on the shash table
 * @ht: pointer
 * @new: pointer
 * Return: void
 */
...
/**
 * shash_table_set - Function that adds a hash (key, value)
...
/**
 * shash_table_print - Function that prints the keys and 
 * values of the shash table
 * @ht: pointer
 * Return: void
 */
...
/**
 * shash_table_print_rev - Function that prints the keys and 
 * values of the shash table in reverse
 * @ht: pointer
 * Return: void
 */
